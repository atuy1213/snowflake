...
resource "aws_iam_role" "github-actions-ro-role" {
  ...
  assume_role_policy = templatefile(
    "${path.module}/policy/iam_actions_ro_assume_role_policy.json",
    {
...
resource "aws_iam_policy" "github-actions-ro-policy" {
  ...
  policy = templatefile("${path.module}/policy/iam_actions_ro_policy.json", {})
}
...
resource "aws_iam_role" "github-actions-rw-role" {
  ...
  assume_role_policy = templatefile(
    "${path.module}/policy/iam_actions_rw_assume_role_policy.json",
    {
      account_id = var.aws_account_id
      github_org     = local.github_org
      github_repo    = local.github_repo
...
resource "aws_iam_policy" "github-actions-rw-policy" {
  ...
  policy = templatefile("${path.module}/policy/iam_actions_rw_policy.json", {})
}
...
resource "aws_iam_role" "github-actions-ecr-rw-role" {
  ...
  assume_role_policy = templatefile(
    "${path.module}/policy/iam_actions_ecr_rw_assume_role_policy.json",
    {
      account_id = var.aws_account_id
      github_org     = local.github_org
      github_repo    = local.github_repo
...
resource "aws_iam_policy" "github-actions-ecr-rw-policy" {
  ...
  policy = templatefile("${path.module}/policy/iam_actions_ecr_rw_policy.json", {})
}
